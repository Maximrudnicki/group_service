...
func (g *GroupRepositoryImpl) AddStudent(ctx context.Context, userId uint32, groupId string) error {
...
func (g *GroupRepositoryImpl) FindByStudentId(ctx context.Context, userId uint32) ([]model.Group, error) {
...
func (g *GroupRepositoryImpl) FindByTeacherId(ctx context.Context, userId uint32) ([]model.Group, error) {
...
func (g *GroupRepositoryImpl) IsStudent(ctx context.Context, userId uint32, groupId string) bool {
...
func (g *GroupRepositoryImpl) IsTeacher(ctx context.Context, userId uint32, groupId string) bool {
	group, err := g.FindById(ctx, groupId)
	if err != nil {
		return false
	}
...
func (g *GroupRepositoryImpl) RemoveStudent(ctx context.Context, userId uint32, groupId string) error {
	group, err := g.FindById(ctx, groupId)
	if err != nil {
